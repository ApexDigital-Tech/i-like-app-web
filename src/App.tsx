...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex text-zinc-100 selection:bg-primary/30">
      ...
      {/* WhatsApp Link Bridge - Repositioned */}
      <div className="fixed bottom-8 right-8 md:bottom-12 md:right-12 z-[100]">
        <a 
          href="https://wa.me/59178756107" 
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-[0_10px_40px_rgba(37,211,102,0.5)] hover:scale-110 active:scale-95 transition-all group border-4 border-white/20"
          title="Soporte WhatsApp"
        >
          <Phone className="w-7 h-7 animate-pulse group-hover:animate-none" />
        </a>
      </div>
